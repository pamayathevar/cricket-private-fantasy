-- Complete the transfer ledger for the clean IPL 2026 bulk lineup import.
-- Match 2 was repaired separately; this migration is limited to Matches 3–20.
-- It mirrors submit_lineup_with_transfer_enforcement and is idempotent.
begin;
...
with ordered_lineups as (
  ...
  where ordered.match_number between 3 and 20
